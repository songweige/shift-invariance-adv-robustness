...
python test_cifar.py --model resnet_max_pooling_34 > /vulcanscratch/songweig/logs/adv_pool/resnet_max_pooling_PGD_34.txt
...
python test_cifar.py --model resnet_max_pooling_50 > /vulcanscratch/songweig/logs/adv_pool/resnet_max_pooling_PGD_50.txt
...
python test_cifar.py --model resnet_max_pooling_101 > /vulcanscratch/songweig/logs/adv_pool/resnet_max_pooling_PGD_101.txt
...
python test_cifar.py --model resnet_max_pooling_152 > /vulcanscratch/songweig/logs/adv_pool/resnet_max_pooling_PGD_152.txt