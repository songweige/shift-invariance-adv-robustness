...
def ResNet18(no_pooling=False, linear_pooling=False, max_pooling=False):
    if no_pooling:
...
def ResNet34(no_pooling=False, linear_pooling=False, max_pooling=False):
    if no_pooling:
...
def ResNet50(no_pooling=False, linear_pooling=False, max_pooling=False):
    if no_pooling:
...
def ResNet101(no_pooling=False, linear_pooling=False, max_pooling=False):
    if no_pooling:
...
def ResNet152(no_pooling=False, linear_pooling=False, max_pooling=False):
    if no_pooling:
